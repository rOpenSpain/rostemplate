...
| [dieg                                                                        |
| hernan](https://github.com/rOpenSpain/rostemplate/commits?author=dieghernan) |
+------------------------------------------------------------------------------+

### Issues

+--------------------------------------+--------------------------------------+
| [![](https://avatars.githubus        | [![](https://avatars.githubuserconte |
| ercontent.com/u/4542928?v=4){alt=""} | nt.com/u/6818218?u=c0a96a5dc32b3035f |
| ](https://github.com/Enchufa2)\      | 057ee75a7679680363b1a89&v=4){alt=""} |
| [Enchufa2](https://git               | ](https://github.com/llrs)\          |
| hub.com/rOpenSpain/rostemplate/issue | [llrs](https:/                       |
| s?q=is%3Aissue+commenter%3AEnchufa2) | /github.com/rOpenSpain/rostemplate/i |
|                                      | ssues?q=is%3Aissue+commenter%3Allrs) |
+--------------------------------------+--------------------------------------+

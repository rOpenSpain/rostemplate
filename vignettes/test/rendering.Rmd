...
subtitle: "Subtitle is skipped from the table of contents"
author: "Author is skipped from the table of contents"
date: "Date is skipped from the table of contents"
---
...
```{r}
#| jarl-ignore-chunk:
#|   - internal_function: This tests pkgdown's internal ruler rendering.
pkgdown:::ruler()
...
#| jarl-ignore-chunk:
#|   - unreachable_code: This chunk follows an intentional error example.
plot(1:42)
```

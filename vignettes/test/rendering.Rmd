...
description: "Tests pkgdown output rendering across common article elements."
...
#| jarl-ignore-chunk:
#|   - unreachable_code: This chunk intentionally tests rendering after previous example errors.
plot(1:42)
```

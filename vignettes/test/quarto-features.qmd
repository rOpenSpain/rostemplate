...
description: >
  Check Quarto-specific article features such as citations and shortcodes.
...
Callout types include `note`, `tip`, `warning`, `caution` and `important`.
...
such as Note, Warning, Important, Tip or Caution.
...
The output of that inline code cell is {{< contents a-span >}}.
...
Cute puppies (@fig-pitbull and @fig-shar-pei) and a placeholder
(@fig-placeholder).
::::

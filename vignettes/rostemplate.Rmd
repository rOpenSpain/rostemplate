...
Este paquete es un *proof of concept* sobre cómo crear una plantilla de 
`pkgdown` adaptada. En este paquete la plantilla base que se adaptará se basa 
en la empleada por la comunidad [rOpenSpain](https://ropenspain.es/), que a su 
vez es una adaptación de la plantilla [Universal](https://bootstrapious.com/p/universal-business-e-commerce-template) 
...
Adicionalmente, es necesario añadir al archivo `.Rbuildignore` las siguientes líneas:

...
óptimo. Para solucionarlo se han empleado algunos *hacks* en el fichero `css` y
pequeños fragmentos en `javascript`.

Otra limitación es la diferencia de versiones Bootstrap, ya que esta plantilla
`pkgdown` emplea la versión Bootstrap 5 mientras que Universal emplea la 3.3.7.
